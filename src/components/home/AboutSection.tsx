    ...
    <section className="py-24 bg-[#FAF7F2] relative overflow-hidden border-t border-brand-beige/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative flex flex-row gap-4 sm:gap-6 items-start w-full pb-16 sm:pb-24">
            {/* Image 1: Preparing Botanicals */}
            {/* 💡 PERFECT RESTORATION: Retained your premium rounded-[2.5rem] / rounded-[3rem] layout configuration safely on all viewports */}
            <div className="w-[55%] aspect-[3/4] rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden shadow-xl border border-brand-cream/80 relative group">
              <img
            ...
            {/* Image 2: Cured Soap Stack with Desktop Offset Layout preserved */}
            {/* 💡 PERFECT RESTORATION: Re-instituted your 'sm:translate-y-12' vertical spacing offset exactly as seen in image_3f5f3e.jpg */}
            <div className="w-[45%] aspect-[3/4] rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden shadow-lg border border-brand-cream/80 relative sm:translate-y-12 group">
              <img
              ...
              {/* Floating Curing Badge Label matching your premium black brand asset styling */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-brand-black text-brand-cream px-4 py-2.5 rounded-xl sm:rounded-2xl shadow-lg z-20 flex items-center space-x-2 border border-brand-gold/20 hover:scale-105 transition-transform min-w-[85%] justify-center">
                <span className="text-lg sm:text-xl font-serif-playfair text-brand-gold">
                  6
                </span>
                <span className="text-[8px] sm:text-[9px] uppercase font-sans-poppins tracking-widest font-semibold text-brand-cream/90 leading-tight text-left">
                  Weeks of <br /> Curing
                </span>
              </div>
            </div>
          ...
          <div className="lg:col-span-6 flex flex-col space-y-8 text-left">
            <div className="space-y-4">
              ...
              <h2 className="font-serif-playfair text-3xl sm:text-4xl lg:text-5xl text-brand-black tracking-tight leading-tight font-light font-medium">
                ...
                <span className="italic font-serif-cormorant text-brand-gold font-normal">
                  Cured in Unhurried Silence
                </span>
              </h2>
            ...
            <p className="font-sans-inter text-sm text-brand-black/70 leading-relaxed font-light">
              Lavish Lathers is born from a desire to return back to traditional
              soapmaking. We reject chemical surfactants, artificial foaming
              agents, and mass-market speed. Instead, we use cold-process oil
              saponification.
            </p>

            <blockquote className="border-l-2 border-brand-gold pl-4 py-1 italic font-serif-cormorant text-lg text-brand-black/85">
              “Every block represents an individual design of botanical
              nature—marbled, poured, pressed, and trimmed by hands that value
              fine luxury art.”
            </blockquote>
