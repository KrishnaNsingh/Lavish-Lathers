...
export default function SouvenirSection({
  ...
  const souvenirs = products
    .filter((p) => p.type === "souvenir" || p.isCollectible)
    .slice(0, 2);
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="font-serif-playfair text-3xl sm:text-4xl lg:text-5xl text-brand-black tracking-tight leading-tight font-light font-medium">
            ...
            <span className="italic font-serif-cormorant text-brand-gold font-normal">
              To Elevate Emotional Milestones
            </span>
          </h2>
          ...
          <p className="font-sans-inter text-sm text-brand-black/60 font-light leading-relaxed">
            Crafted for weddings, anniversaries, corporate caskets, and elite
            events. Each soap curio or lace-pressed structure is bound in silk,
            wax-checked, and arrives with an elegant customizable calligraphic
            note.
          </p>
        </div>
          ...
          <div className="lg:col-span-4 space-y-8 bg-brand-cream/50 backdrop-blur-md p-8 sm:p-10 rounded-[2.5rem] border border-brand-beige/20 text-left shadow-lg shadow-brand-black/[0.02]">
            <div className="space-y-4">
              ...
              <p className="font-sans-inter text-xs text-brand-black/70 leading-relaxed font-light">
                Our luxury souvenirs are not merely functional cleansing
                products—they are collectible sculptures formulated with premium
                rose hydrosols and gold flakes that naturally freshen your
                personal powder rooms.
              </p>
            </div>

            <ul className="space-y-4 font-sans-inter text-xs text-brand-black/80 font-normal">
              <li className="flex items-start space-x-3">
                <span className="p-1 rounded-full bg-brand-pink text-brand-gold shrink-0 mt-0.5 font-bold">
                  ✓
                </span>
                <span>
                  <strong>Bespoke Satin Ribbon Trimming:</strong> Choice of
                  royal marine, baby rose, or crisp ivory silk cords.
                </span>
              </li>
              <li className="flex items-start space-x-3">
                <span className="p-1 rounded-full bg-brand-pink text-brand-gold shrink-0 mt-0.5 font-bold">
                ...
                <span>
                  <strong>Anatomical Scent Diffusion:</strong> Active Damascus
                  Rose oil emits ambient botanical aroma for up to 90 days
                  offline.
                </span>
              </li>
              <li className="flex items-start space-x-3">
                ...
                <span>
                  <strong>Prestige Wax Seals:</strong> Secured by our master
                  artisans via authentic gold wax seal stamps.
                </span>
              </li>
            </ul>
