...
interface ProductDetailsModalProps {
  product: Product;
  onBack: () => void;
  onAddToCart: (product: Product, isGift: boolean, giftNote?: string, giftRecipient?: string, quantity?: number) => void;
  products: Product[];
...
export default function ProductDetailsModal({
  ...
  const handleAddToBag = () => {
    onAddToCart(product, isGift, isGift ? giftNote : undefined, isGift ? giftRecipient : undefined, quantity);
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 space-y-8 text-left">
            <div>
              ...
              <div className="flex items-center space-x-3 mt-2">
                ...
                <span className="text-[11px] font-sans-poppins font-medium text-brand-black/60 pt-0.5">
                  {(product.rating).toFixed(1)} Rating ({product.reviewsCount + localReviews.length} Patron Reviews)
                </span>
              </div>
            </div>
            ...
            <div className="bg-[#FAF7F2] border-y border-brand-beige/20 py-4 flex items-center justify-between">
              <div>
                <span className="text-[10px] uppercase tracking-widest font-sans-poppins text-brand-black/45 block mb-0.5">Total Value (INR)</span>
              ...
              <div className="text-right">
                <span className="text-[10px] uppercase tracking-widest font-sans-poppins text-brand-black/45 block mb-1">Status</span>
                {product.stock > 0 ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex items-center justify-between border border-brand-beige/40 bg-[#FAF7F2] rounded-full p-2 w-full sm:w-36">
                  ...
                  <span className="font-sans-poppins text-sm font-semibold">{quantity}</span>
                  <button
            ...
            <div className="pt-8 border-t border-brand-beige/20 space-y-6">
              ...
              <form onSubmit={handleReviewSubmit} className="bg-[#FAF7F2] border border-brand-beige/30 p-6 rounded-2xl text-left space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-[9px] uppercase tracking-widest font-sans-poppins text-brand-black/50 mb-1">Rating Star Selection</label>
                    <select
                      value={reviewRating}
