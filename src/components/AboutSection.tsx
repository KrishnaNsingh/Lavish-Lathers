        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative flex flex-col sm:flex-row gap-6 items-stretch">
            ...
            <div className="w-full sm:w-[45%] aspect-[3/4] rounded-[2.5rem] overflow-hidden shadow-lg border border-brand-cream/80 relative sm:translate-y-12 group">
              <img
                src="https://images.unsplash.com/photo-1605264964521-300ed3f3149b?auto=format&fit=crop&q=80&w=600"
          ...
          <div className="lg:col-span-6 flex flex-col space-y-8 text-left">
            ...
            <div className="pt-2">
              <button
                ...
                className="group flex items-center space-x-2 text-xs font-semibold uppercase tracking-widest font-sans-poppins text-brand-black hover:text-brand-gold transition-colors"
