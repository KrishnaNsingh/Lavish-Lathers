          ...
          <div className="lg:col-span-3 space-y-8 bg-brand-cream border border-brand-beige/25 p-6 sm:p-8 rounded-[2rem] text-left shadow-lg shadow-brand-black/[0.01]">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col space-y-1.5 pl-1">
                {categories.map((cat) => (
                  ...
                  >
                    <span>{cat}</span>
                    <ChevronRightLine isActive={selectedCategory === cat} />
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-2 pt-4 border-t border-brand-beige/25">
              ...
              <select
                ...
                className="w-full text-xs px-3 py-3 rounded-xl border border-brand-beige/40 bg-[#FAF7F2] text-brand-black font-sans-poppins text-[11px] uppercase tracking-wider font-semibold focus:outline-none focus:border-brand-gold"
                id="catalog-sort"
              >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-6 text-left flex flex-col flex-grow bg-[#FAF7F2] transition-colors duration-300 group-hover:bg-brand-ivory/50">
                        ...
                        {/* Row pricing */}
                        <div className="mt-auto pt-3 flex items-center justify-between border-t border-brand-beige/10">
