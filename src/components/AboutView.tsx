...
import { Leaf, Award, Heart, CheckCircle, Quote, Sparkles } from 'lucide-react';
    ...
    <div className="bg-[#FAF7F2] py-16 text-brand-black text-left font-sans-inter">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h1 className="font-serif-playfair text-4xl sm:text-5xl tracking-tight leading-tight text-brand-black font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center mb-24">
          <div className="md:col-span-6 space-y-6">
            ...
            <p className="text-xs sm:text-sm text-brand-black/70 leading-relaxed font-light">
            ...
            <div className="border-l-2 border-brand-gold pl-4 italic font-serif-cormorant text-lg text-brand-black/85">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-24 bg-brand-cream border border-brand-beige/25 p-8 rounded-[2.5rem] shadow-sm">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-brand-black/60 font-light px-4 leading-normal">Our items develop structural density in cedar vaults before they leave our workshop.</p>
          </div>
          ...
          <div className="text-center space-y-2 border-y sm:border-y-0 sm:border-x border-brand-beige/20 py-6 sm:py-0">
            ...
            <p className="text-xs text-brand-black/60 font-light px-4 leading-normal">Zero testing on animals, zero petrochemical color solvents or paraben detergents.</p>
          </div>
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-brand-black/60 font-light px-4 leading-normal">Every souvenir box features a customized Cotton scroll stamped with warm wax seals.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center mb-16">
          ...
          <div className="md:col-span-6 space-y-6">
            ...
            <ul className="space-y-2.5 font-sans-inter text-xs text-brand-black/80">
        ...
        {/* VISION BLOCK DARK (Reflects design parameters) */}
