...
export default function Navbar() {
  ...
  const { cart, wishlist, setFilterCategory, filterCategory, setIsCartOpen } =
    useApp();
  ...
  return (
    <header className={headerClass} id="app-nav-header">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`grid grid-cols-3 items-center min-h-[64px] md:min-h-[110px] py-1.5 md:py-2 border-b transition-colors duration-500 ${
        ...
        >
          ...
          <div className="flex items-center justify-center text-center">
            <Link
              ...
              id="brand-logo-btn"
            >
              <div className="transition-all duration-300 transform group-hover:scale-105 shrink-0 h-5.5 w-5.5 sm:h-6.5 sm:w-6.5 md:h-8 md:w-8">
                <img
                  src="https://res.cloudinary.com/dzowyrkcg/image/upload/v1780560403/WhatsApp_Image_2026-06-04_at_13.35.43_hlpdxl.jpg"
                  alt="Lavish Lathers Logo"
